...
function DecretoTab() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 text-center mb-6">{decreto.titulo}</h2>
      <div
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-sm border space-y-4">
        <h3 className="text-lg font-semibold text-gray-900 border-b pb-2">Datos del Conductor</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 border-b pb-2 pt-2">Datos del Parrillero (Acompanante)</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
        ...
        <h3 className="text-lg font-semibold text-gray-900 border-b pb-2 pt-2">Datos de la Motocicleta</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 border-b pb-2 pt-2">Motivo de la Excepcion</h3>
        <div>
...
function AdminLogin({ onLogin }: { onLogin: () => void }) {
  ...
  return (
    <div className="max-w-md mx-auto mt-12">
      <h2 className="text-2xl font-bold text-gray-900 text-center mb-6">Panel de Administracion</h2>
      {error && (
        <div className="bg-red-50 border-l-4 border-red-400 p-4 mb-4 rounded">
          <p className="text-red-800 text-sm">{error}</p>
        </div>
